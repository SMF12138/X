...
async function getInferredCompilerOptions(configurationHost) {
    let [implicitProjectConfig_1, implicitProjectConfig_2] = await Promise.all([
        configurationHost?.getConfiguration('js/ts.implicitProjectConfig'),
        configurationHost?.getConfiguration('javascript.implicitProjectConfig'),
    ]);
